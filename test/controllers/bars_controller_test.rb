...
class BarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bar" do
    assert_difference("Bar.count") do
      post bars_url, params: { bar: { city: @bar.city, description: @bar.description, name: @bar.name } }
    end
  ...
  test "should update bar" do
    patch bar_url(@bar), params: { bar: { city: @bar.city, description: @bar.description, name: @bar.name } }
