...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference("Drink.count") do
      post drinks_url, params: { drink: { bar_id: @drink.bar_id, name: @drink.name, price: @drink.price } }
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { bar_id: @drink.bar_id, name: @drink.name, price: @drink.price } }
